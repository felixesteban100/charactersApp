    ...
    return (
        <div className={`navbar ${showBackground ? 'bg-base-300 bg-opacity-100' : ''} sticky top-0 z-40 transition duration-500`}>
            ...
            {/* <div className="flex-none">
                ...
                {/* <label htmlFor="my-drawer-settings" className="btn btn-circle btn-ghost">
